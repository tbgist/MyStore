package cn.mystore.service;
import java.sql.SQLException;
import java.util.Date;
import javax.security.auth.login.LoginException;
import cn.mystore.dao.UserDao;
import cn.mystore.domain.User;
import cn.mystore.exception.ActiveUserException;
import cn.mystore.exception.RegisterException;
import cn.mystore.utils.MailUtils;
	...
	public void register(User user) throws RegisterException {
		...
		try {
			...
			String emailMsg = "感谢您注册网上书城，点击"
					+ "<a href='http://127.0.0.1:8080/MyStore/activeUser?activeCode="
